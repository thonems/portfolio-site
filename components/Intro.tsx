  ...
  return (
    ...
    >
      ...
      <p className="mb-10 mt-6 px-4 text-2x1 font-medium leading-[1.5] sm:text-4x1">
        ...
        backend developer. I thrive on coding challenges and enjoy exploring
        innovative technologies. When I’m not coding, I’m often watching movies,
        gaming with friends, or enjoying the outdoors. Currently, I’m seeking my
